...
router.post('/add/store', trimRequest.all, authenticateUser(["user"]), controller.addStore)

router.get('/get/store', trimRequest.all, authenticateUser(["user"]), controller.getStore)

router.patch('/edit/store', trimRequest.all, authenticateUser(["user"]), controller.editStore)
...
router.get('/get/emails', trimRequest.all, authenticateUser(["user"]), controller.getEmails)

router.post('/add/emails', trimRequest.all, authenticateUser(["user"]), controller.addEmails)
...
router.post('/client', trimRequest.all, authenticateUser(["user"]), controller.client)

router.get('/get/client', trimRequest.all, authenticateUser(["user"]), controller.getClient)

router.post('/download/csv', trimRequest.all, controller.downloadCsv)

router.post('/invoice', trimRequest.all, authenticateUser(["user"]), controller.invoice)

router.post('/quote', authenticateUser(["user"]), trimRequest.all, controller.quote)
...
router.post('/free/quotes', trimRequest.all, authenticateUser(["user"]), controller.freeQuotes)

router.post('/calendar', trimRequest.all, authenticateUser(["user"]), controller.calendar)
//  new ===========apis
...
router.get('/getservices', trimRequest.all, authenticateUser(["user"]), controller.getservices)
...
router.get('/GRAPHAPI', trimRequest.all, authenticateUser(["user"]), controller.GRAPHAPI)
...
router.post('/todo', authenticateUser(["user"]), trimRequest.all, controller.addTodo)
router.get('/todo', authenticateUser(["user"]), trimRequest.all, controller.getTodos)
router.put('/todo/:id', authenticateUser(["user"]), trimRequest.all, controller.updateStatus)
router.delete('/todo/:id', authenticateUser(["user"]), trimRequest.all, controller.deleteTodo)
router.get(
  '/clients-cars/:id',
  authenticateUser(["user"]),
  trimRequest.all,
...
router.post('/check-password', authenticateUser(["user"]), controller.verifyPassword)
...
router.post('/send-reminder/:id', authenticateUser(["user"]), controller.sendRemainder)
router.post('/send-email-reminder', authenticateUser(["user"]), controller.sendReminderEmail)
router.get('/email-follow-up', authenticateUser(["user"]),controller.getAllFollowUpEmails)
router.get(
  '/total-repair-list',
...
router.post('/add-car-model', authenticateUser(["user"]), controller.addCarModel)
...
router.delete('/remove-card/:id', authenticateUser(["user"]), controller.removeCard)
router.post('/add-card', authenticateUser(["user"]), controller.addCard)
router.post('/process-payment', authenticateUser(["user"]), controller.processPayment)
// router.all("/webhook",controller.trackPayment);
router.patch("/update-profile",authenticateUser(["user"]), controller.updateProfile);
router.post("/add-clicks",controller.addClicks);
router.post("/add-newcar-model",authenticateUser(["user"]), controller.addCarModelBYUser);
router.post("/add-contactUs-user",authenticateUser(["user"]), controller.addAppContactUs);
router.post("/add-new-car",authenticateUser(["user"]), controller.addCarAndModel);
router.post("/invoice-card-payment",authenticateUser(["user"]),controller.garagePayment);
router.post("/update-invoice",authenticateUser(["user"]), controller.updatePaymentInvoice);
router.get("/invoice/download/:id",controller.downloadSingleInvoice);
router.get("/invoices/data",authenticateUser(["user"]),controller.getInvoiceData);
router.patch("/approve-invoice-draft/:id",authenticateUser(["user"]),controller.approveInvoiceDraft);
router.delete("/delete/invoice/:id",authenticateUser(["user"]),controller.deleteInvoice)
...
router.delete("/subuser/:id",authenticateUser(['user']),controller.deleteSubUser);
router.get("/get/quoation/:id",authenticateUser(['user']),controller.findQuotation);
router.get("/invoice/details/:id",authenticateUser(['user']),controller.getInvoiceDetails)
